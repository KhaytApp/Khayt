...
|---------|--------|--------|-------------|
| **Stable** | `v3.10.1` (published 2026-09-26, **all three platforms** — `BUILD_MAC` is on until the native Mac app reaches beta). Supersedes `v3.10.0` (2026-09-26, all three platforms), which superseded `v3.9.2` (2026-09-25, **all three platforms** — `BUILD_MAC` is on until the native Mac app reaches beta, so a macOS shop on the Electron app moves from 3.7.0 to 3.9.2). Supersedes `v3.9.1` (2026-09-24, Windows and Linux only), which superseded `v3.9.0` (2026-09-23, Windows and Linux only), which superseded `v3.8.0` (2026-09-21, Windows and Linux only), which superseded `v3.7.0` (2026-09-11, all three platforms) | [Latest release](https://github.com/khaytapp/Khayt/releases/latest) | Default (beta off) |

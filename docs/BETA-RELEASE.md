...
|---------|--------|--------|-------------|
| **Stable** | `v3.8.0` (published 2026-09-18, **Windows and Linux only** — `BUILD_MAC` was left false, so macOS carries `v3.7.0`'s manifest forward and a macOS shop is not offered 3.8.0). Supersedes `v3.7.0` (2026-09-11, all three platforms) | [Latest release](https://github.com/khaytapp/Khayt/releases/latest) | Default (beta off) |

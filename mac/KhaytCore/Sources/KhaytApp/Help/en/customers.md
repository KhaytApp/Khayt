...
The people you print for, with the details that end up on an invoice.

## What Khayt keeps

Both names — English and Arabic — because a Saudi shop keeps both and an invoice
may need either. Either one alone is enough.

Alongside them: phone, email, the commercial registration and VAT numbers that a
Saudi invoice carries, and notes.

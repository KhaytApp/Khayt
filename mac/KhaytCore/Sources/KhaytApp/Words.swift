...
final class Words {
    ...
    private nonisolated static let base: [String: [String: String]] = [
        ...
        "cl.title": ["en": "Online storage", "ar": "التخزين السحابي"],
        "cl.why": ["en": "Keep a copy of every model in a bucket, and move models nobody has used for a while there to free this Mac’s disk. The Windows and Linux app uses the same bucket and the same settings.", "ar": "احتفظ بنسخة من كل مجسّم في حاوية تخزين، وانقل المجسّمات غير المستخدمة منذ مدة إليها لتوفير مساحة القرص. تطبيق ويندوز ولينكس يستخدم الحاوية والإعدادات نفسها."],
        "cl.provider": ["en": "Provider", "ar": "المزوّد"],
        "cl.endpoint": ["en": "Endpoint", "ar": "نقطة الاتصال"],
        "cl.bucket": ["en": "Bucket", "ar": "الحاوية"],
        "cl.region": ["en": "Region", "ar": "المنطقة"],
        "cl.prefix": ["en": "Folder inside the bucket", "ar": "مجلد داخل الحاوية"],
        "cl.key_id": ["en": "Access key ID", "ar": "معرّف مفتاح الوصول"],
        "cl.secret": ["en": "Secret access key", "ar": "مفتاح الوصول السري"],
        "cl.back_up": ["en": "Back up new models to the bucket", "ar": "انسخ المجسّمات الجديدة إلى الحاوية"],
        "cl.back_up_all": ["en": "Back up the whole library now", "ar": "انسخ المكتبة كلها الآن"],
        "cl.test": ["en": "Test connection", "ar": "اختبار الاتصال"],
        "cl.tier": ["en": "Move old models to the cloud to free up space", "ar": "انقل المجسّمات القديمة إلى السحابة لتوفير المساحة"],
        "cl.keep_days": ["en": "Keep on this Mac for", "ar": "أبقِها على هذا الماك لمدة"],
        "cl.days": ["en": "days", "ar": "يوم"],
        "cl.free_now": ["en": "Free up space now", "ar": "وفّر المساحة الآن"],
        "cl.bring_all": ["en": "Bring everything back", "ar": "أعد كل شيء"],
        "cl.not_set_up": ["en": "Set up the bucket first: provider, bucket and access key.", "ar": "أعدّ الحاوية أولًا: المزوّد والحاوية ومفتاح الوصول."],
        "cl.test_ok": ["en": "Wrote, read back and removed a test file.", "ar": "كُتب ملف اختبار وقُرئ ثم حُذف."],
        "cl.test_mismatch": ["en": "The test file came back different from what was sent.", "ar": "عاد ملف الاختبار مختلفًا عمّا أُرسل."],
        "cl.test_failed": ["en": "The bucket refused:", "ar": "رفضت الحاوية:"],
        "cl.backup_some_failed": ["en": "{n} models could not be backed up.", "ar": "تعذّر نسخ {n} من المجسّمات."],
        "cl.backed_up_all": ["en": "Backed up {n} of {total} files.", "ar": "نُسخ {n} من {total} ملفات."],
        "cl.tier_off": ["en": "Switch on moving old models to the cloud first.", "ar": "فعّل نقل المجسّمات القديمة إلى السحابة أولًا."],
        "cl.freed": ["en": "Moved {n} of {total} models to the cloud, freeing {size}.", "ar": "نُقل {n} من {total} مجسّمات إلى السحابة، وتوفّرت {size}."],
        "cl.brought_back": ["en": "Brought back {n} models.", "ar": "أُعيد {n} من المجسّمات."],
        "cl.bring_back": ["en": "Bring back from the cloud", "ar": "أعده من السحابة"],
        "cl.bring_back_failed": ["en": "Could not bring it back:", "ar": "تعذّرت إعادته:"],
        "cl.in_cloud": ["en": "In the cloud", "ar": "في السحابة"],
        "cl.could_move": ["en": "{n} models could move to the cloud, freeing {size}. {cloud} already there.", "ar": "يمكن نقل {n} من المجسّمات إلى السحابة لتوفير {size}. {cloud} موجودة هناك."],
        "cl.progress": ["en": "{name} ({done} of {total})", "ar": "{name} ({done} من {total})"],
        "cl.saved": ["en": "Online storage saved.", "ar": "حُفظ التخزين السحابي."],
        "cl.safety": ["en": "Nothing leaves this Mac until the bucket has confirmed it holds the exact file, in a separate check.", "ar": "لا يُحذف شيء من هذا الماك قبل أن تؤكد الحاوية، في فحص مستقل، أنها تحمل الملف نفسه تمامًا."],

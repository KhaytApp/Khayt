...
public actor KhaytEngine {
    ...
    public struct Recipient: Decodable, Sendable {
        ...
        /// Spelled out because the memberwise one a struct gets for free is
        /// internal, and a test in the app module builds a recipient by hand
        /// to prove a refusal happens before anything is posted.
        public init(client: JSONValue, contact: String, stats: Stats) {
            self.client = client
        ...
        public struct Stats: Decodable, Sendable {
            ...
            public init(completedCount: Int, totalSpend: Double, lastOrderDate: String) {
